#!/usr/bin/env python
# -*- coding: utf-8 -*-
# from http://code.activestate.com/recipes/496942/ under PSF license
...
#TODO ACR allows only XML inputs so HTMLParser is not required here
#TODO delete bad content instead escape it - saves space

class XssCleaner(HTMLParser):
	def __init__(self, tags=None, attrs=None, fmt = AbstractFormatter):
...
#			'br',
		...
		self.allowed_attributes = attrs or {
			'a':['href','title'],
			'img':['src','alt']
		}
